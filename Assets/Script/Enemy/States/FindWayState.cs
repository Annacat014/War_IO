...
namespace LearnGame.Enemy.States
{
    ...
    {
        private const float MaxDistanceBetweenRealAndCalculared = 3f;
        ...
        { 
           Vector3 targetPosition = _target.Closest.transform.position;
            ...
            if( !_navMesher.IsPathCalculated || _navMesher.DistanseToTargetPointFrom(targetPosition) > 
                MaxDistanceBetweenRealAndCalculared)
            {
